...
public class Program
{
    ...
    private static readonly IGreetingWriter _greetingWriter;
    ...
    static Program()
    {
        ...
        //we could move this to a separate method, but it gets called only once during runtime so it can also go here in the constructor
        ...
        //I was not sure about the question mark:
    ...
    {
        //_greetingWriter.Write("blabla");

        //var myGreeting = new Greeting();
        //myGreeting.Message = "TestMessage";
