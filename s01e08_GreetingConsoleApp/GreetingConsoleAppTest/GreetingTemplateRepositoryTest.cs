...
namespace GreetingConsoleAppTest
{
    ...
    public class GreetingTemplateRepositoryTest
    {
        ...
        public void test_GetGreetingTemplatesByLengthWithLinq()
        {
            ...
            // ; var mynewlist = myListOfLengths.Reverse(); //This I find very strange, I can't seem to rename the sorted list

            //Here instead of creating a list and adding the lengths and then sorting them, we just do it inline on the fly
            var myNewList = myTemplate.GreetingTemplates.Values.ToList().OrderByDescending(g => g.Message.Length);
