...
public class Program
{
    ...
    static Program()
    {
        ...
        if (_settings.GreetingWriterClassName == "FileGreetingWriter")
        {
        ...
        else if (_settings.GreetingWriterClassName == "JsonGreetingWriter")
        {
            _greetingWriter = new JsonGreetingWriter();
        }
        else if (_settings.GreetingWriterClassName == "XMLGreetingWriter")
        {
